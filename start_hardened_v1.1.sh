...
# 1. Deduplicate Leaderboard (using SE3nv for pandas)
...
echo "Launching Standardized Production Environment (v1.1)..."

# 3. Start Generation
tmux new-session -d -s prod_gen "source $CONDA_SH && conda activate SE3nv && cd $PROJECT_DIR && bash $BIN_DIR/generator.sh"
